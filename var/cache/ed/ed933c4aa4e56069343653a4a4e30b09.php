...
/* delete_source.html */
class __TwigTemplate_9f9d7748d33a59eb2224df197f48691f extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layout.html", "delete_source.html", 1);
...
{% block content %}
  ...
  <main class=\"sources_container\" id=\"content\">
    <form action=\"{{ doc_root }}delete-source/{{ source.id }}\" method=\"POST\" class=\"narrow\">
      ...
      <input type=\"submit\" name=\"delete\" value=\"confirm\" class=\"button button_green\" />
      <a href=\"{{ doc_root }}sources/{{ session.id }}\" class=\"button button_gray\">Cancel</a>
    </form>
  </main>
