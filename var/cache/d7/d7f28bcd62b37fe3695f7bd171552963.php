...
/* words_display.html */
class __TwigTemplate_464e6e7877343ab4e76b3db332cc58b2 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("words.html", "words_display.html", 1);
...
";
    ...
    {
        return array (  103 => 14,  88 => 12,  84 => 11,  81 => 10,  74 => 9,  63 => 5,  59 => 3,  52 => 2,  41 => 1,);
    }
...
{% block main %}
    <section class=\"word_grid\">      
        {% for word in words %}
            <a class=\"word\" href=\"{{ doc_root }}word/{{word.id}}\" style=\"text-decoration: underline; text-decoration-color: {{ word.color }}; text-decoration-thickness: 3px;\">{{ word.word }}</a>
        {% endfor %}
    </section>
