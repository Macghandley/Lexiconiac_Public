...
/* delete_word.html */
class __TwigTemplate_c9bd7ec24edc55d8e274d94ea8d40b67 extends Template
{
...
{% block content %}
  ...
  <main class=\"word_container\" id=\"content\">
    ...
    <form action=\"{{ doc_root }}delete-word/{{ word.id }}\" method=\"POST\" class=\"narrow\">
      ...
      <input type=\"submit\" name=\"delete\" value=\"confirm\" class=\"button button_green\" />
      <a href=\"{{ doc_root }}words/{{ session.id }}/{{ session.username }}\" class=\"button button_gray\">Cancel</a>
    </form>
  </main>
