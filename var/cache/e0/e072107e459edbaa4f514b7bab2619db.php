...
class __TwigTemplate_fa3fbb76292b83d2c1dfb6bbb645f657 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("sources.html", "sources_display.html", 1);
...
";
    ...
    {
        return array (  102 => 13,  87 => 11,  83 => 10,  80 => 9,  73 => 8,  63 => 5,  59 => 3,  52 => 2,  41 => 1,);
    }
...
<section class=\"source_grid\">
    {% for source in sources %}
        <a href=\"{{ doc_root }}source/{{source.id}}\" style=\"text-decoration: underline; text-decoration-color: {{ source.color }}; text-decoration-thickness: 3px;\">{{ source.source }}</a>
    {% endfor %}
</section>
{% endblock %}
