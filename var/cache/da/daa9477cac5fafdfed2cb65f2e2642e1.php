...
/* source.html */
class __TwigTemplate_7523e42542362653a785e1f465fc0659 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("sources_display.html", 1);
  ...
  <div class=\"single_source_header\">
    <a href=\"";
        ...
        yield "/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "username", [], "any", false, false, false, 5), "html", null, true);
  ...
  <section class=\"source_info\">
    ...
    ";
        // line 17
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(($context["words"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 18
            yield "    <p><b>Words Associated:</b></p>
    <ul>
        ";
            // line 20
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["word"]) {
                // line 21
                yield "            <li>";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["word"], "word", [], "any", false, false, false, 21), "html", null, true);
                yield "</li>
        ";
            }
    ...
    ";
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
        yield "edit-source/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["source"] ?? null), "id", [], "any", false, false, false, 27), "html", null, true);
        yield "/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "username", [], "any", false, false, false, 27), "html", null, true);
        yield "\" class=\"button button_orange\" title=\"Edit Source\">Edit</a>
    <a href=\"";
        // line 28
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["doc_root"] ?? null), "html", null, true);
        yield "delete-source/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["source"] ?? null), "id", [], "any", false, false, false, 28), "html", null, true);
        yield "/";
...
";
    ...
    {
        return array (  132 => 28,  123 => 27,  119 => 25,  115 => 23,  106 => 21,  102 => 20,  98 => 18,  96 => 17,  92 => 16,  88 => 15,  83 => 13,  79 => 12,  70 => 6,  62 => 5,  58 => 3,  51 => 2,  40 => 1,);
    }
...
<main class=\"sources_container\" id=\"content\">
  <div class=\"single_source_header\">
    <a href=\"{{ doc_root }}sources/{{ session.id }}/{{ session.username }}\" class=\"back_button\" title=\"Back\">X</a>
    <h1>{{source.source}}</h1>    
  </div>
  ...
  <section class=\"source_info\">
    ...
    {% else %}
        <p>No words associated.</p>
    {% endif %}
    <a href=\"{{ doc_root }}edit-source/{{source.id}}/{{ session.username }}\" class=\"button button_orange\" title=\"Edit Source\">Edit</a>
    <a href=\"{{ doc_root }}delete-source/{{source.id}}/{{ session.username }}\" class=\"button button_red\" title=\"Delete Source\">Delete</a>
  </section>
</main>
