...
/* word.html */
class __TwigTemplate_022c32e9816e3de4c211d978db3ecd5f extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("words_display.html", 1);
  ...
  <section class=\"word_info\">
    ...
    <a href=\"";
        ...
        yield "/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "username", [], "any", false, false, false, 20), "html", null, true);
...
";
    ...
    {
        return array (  124 => 20,  116 => 19,  112 => 18,  108 => 17,  104 => 16,  100 => 15,  96 => 14,  92 => 13,  88 => 12,  84 => 11,  80 => 10,  76 => 9,  70 => 6,  62 => 5,  58 => 3,  51 => 2,  40 => 1,);
    }
...
<main class=\"word_container\" id=\"content\">
  <div class=\"single_word_header\">
    <a href=\"{{ doc_root }}words/{{ session.id }}/{{ session.username }}\" class=\"back_button\" title=\"Back\">X</a>
    <h1>{{word.word}}</h1>
  </div>
  <section class=\"word_info\">
    ...
    <a href=\"{{ doc_root }}edit-word/{{word.id}}/{{ session.username }}\" class=\"button button_orange\" title=\"Edit Word\">Edit</a>
    <a href=\"{{ doc_root }}delete-word/{{word.id}}/{{ session.username }}\" class=\"button button_red\" title=\"Delete Word\">Delete</a>
  </section>
</main>
