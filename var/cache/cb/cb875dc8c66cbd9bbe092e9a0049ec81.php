...
/* edit_source.html */
class __TwigTemplate_b3315c3f5816d2a0145dadad8d46f729 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("sources.html", "edit_source.html", 1);
...
";
    ...
    public function block_main(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 8
        yield "<main class=\"edit_source_container\" id=\"content\">
    <section class=\"edit_source_form_section\">
...
{% endblock %}
{% block main %}
<main class=\"edit_source_container\" id=\"content\">
    <section class=\"edit_source_form_section\">
        <form method=\"post\" action=\"\" class=\"sourceForm\">
            ...
            <div class=\"button_div\">
                <button class=\"button button_green\" type=\"submit\">Submit</button>
                <a href=\"{{ doc_root }}sources/{{ session.id }}\" class=\"button button_red\">Cancel</a>
            </div>
        </form>
    </section>
</main>
{% endblock %}", "edit_source.html", "C:\\xampp\\htdocs\\lexiconiac\\templates\\edit_source.html");
    }
}
