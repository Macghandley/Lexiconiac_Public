...
/* add_word.html */
class __TwigTemplate_a8a9c98bbade817a29bd5298593fc8ee extends Template
{
...
";
    ...
    public function block_main(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 8
        yield "<main class=\"add_word_container\" id=\"content\">
    <section class=\"add_word_form_section\">
        ...
        yield "/";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["session"] ?? null), "username", [], "any", false, false, false, 38), "html", null, true);
...
";
    ...
    {
        return array (  138 => 38,  124 => 27,  121 => 26,  108 => 24,  104 => 23,  95 => 17,  91 => 16,  86 => 13,  80 => 12,  74 => 8,  67 => 7,  59 => 3,  52 => 2,  41 => 1,);
    }
...
{% endblock %}
{% block main %}
<main class=\"add_word_container\" id=\"content\">
    <section class=\"add_word_form_section\">
        <form method=\"post\" action=\"\" class=\"wordForm\">
            ...
            <div class=\"form-group\">
                ...
                <select id=\"source_id\" name=\"source_id\" required>
                    {% for source in sources %}
                        <option value=\"{{ source.id }}\" style=\"color: {{ source.color }};\">{{ source.source }}</option>
                    {% endfor %}
                </select>
            ...
            <div class=\"button_div\">
                <button class=\"button button_green\" type=\"submit\">Submit</button>
                <a href=\"{{ doc_root }}words/{{ session.id }}/{{ session.username }}\" class=\"button button_red\">Cancel</a>
            </div> 
        </form>
    </section>
</main>
{% endblock %}", "add_word.html", "C:\\xampp\\htdocs\\lexiconiac\\templates\\add_word.html");
    }
}
